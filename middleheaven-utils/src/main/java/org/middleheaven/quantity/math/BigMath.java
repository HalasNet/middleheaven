...
//	    return absA.multiply(BigInteger.valueOf(a.signum() * b.signum()));
    ...
    public static BigDecimal cosProductSerie(BigDecimal x, int scale){
    ...
    public static BigDecimal expProductSerie(BigDecimal x, int scale){
    ...
    public static BigDecimal sinProductSerie(BigDecimal x, int scale){
    ...
    public static BigDecimal arcTanProductSerie(BigDecimal x, int scale){
     ...
     * @return the result value
     */
    public static BigDecimal arctanTaylor(BigDecimal x, int scale) {
