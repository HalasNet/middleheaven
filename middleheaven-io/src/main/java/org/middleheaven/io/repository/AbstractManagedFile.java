...
public abstract class AbstractManagedFile implements ManagedFile {
	...
	private class ManagedFileEnumerable extends AbstractSourceEnumerable<ManagedFile>  {
		...
		public EnumerableSize getSizeInfo() {
			return IntPreciseEnumerableSize.of(childrenCount());
		}
		 ...
		 */
		@Override
		protected Iterator<ManagedFile> reverseIterator() {
			return new StackReverseIterator<ManagedFile>(childrenIterable().iterator());
		}
