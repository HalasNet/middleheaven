...
import org.middleheaven.model.IllegalModelStateException;
...
//				// TODO
	...
	public <T> Query<T> createQuery(final EntityCriteria<T> criteria,StorageUnit unit) {
		...
		return new ParametrizedCriteriaQuery<T>(criteria, new QueryExecuter (){
			...
			@Override
			public <E> Enumerable<E> retrive(EntityCriteria<E> query, ReadStrategy readStrategy,QueryParametersBag queryParametersBag) {
				return inSession( session -> {
					...
					return Enumerables.asEnumerable(hcriteria.list());
