...
public abstract class AbstractHtmlRender extends UIRender{
	...
	protected UIComponent build(RenderingContext context, UIComponent parent, UIComponent component) {
		...
		HtmlUIComponent ruic =   Introspector.of(UIComponent.class).newProxyInstance(
				new HTMLUIComponentProxyHandler(component, this), 
				HtmlUIComponent.class,
				Sequences.of(component.getClass().getInterfaces()));
