...
public final class Version implements Comparable<Version>, Serializable{
	...
	public static Version valueOf(String number) {
		...
		Sequence<String> pars = Splitter.on(".").split(number);
		...
		case 1:
			return new Version(res.get(0), 0, 0, 0, tag);
		case 2:
			return new Version(res.get(0),res.get(1), 0, 0, tag);
		case 3:
			return new Version(res.get(0),res.get(1), res.get(2), 0, tag);
		case 4:
		default:
			return new Version(res.get(0),res.get(1), res.get(2), res.get(3), tag);
		}
