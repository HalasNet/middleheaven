...
public class CatalinaContainerBootstrapEnvironment extends StandardSevletBootstrapEnvironment  {
	...
	public WebContainerInfo getWebContainerInfo() {
		...
		String number = (String) introspector.inspect().methods().beingStatic(true).named("getServerNumber").retrive().invokeStatic(Sequences.empty());
		String serverBuilt = (String) introspector.inspect().methods().beingStatic(true).named("getServerBuilt").retrive().invokeStatic(Sequences.empty());
