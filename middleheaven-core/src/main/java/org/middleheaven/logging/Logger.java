...
public abstract class Logger {
	...
	public static Logger onBook(String bookName){
		...
		Maybe<LoggingService> service = ServiceRegistry.getPossibleUnAvailableService(LoggingService.class);
		if (service.isAbsent()){
			return new LogServiceDelegatorLogger(bookName, new BroadcastLoggingService());
		} else{
			return new LogServiceDelegatorLogger(bookName, service.get());
		}
