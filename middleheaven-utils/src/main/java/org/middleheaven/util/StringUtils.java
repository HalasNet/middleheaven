...
public class StringUtils {
	...
	public static String join(String separator, String ... original){
		return join(separator, 0,original.length, Sequences.of(original));
	}

	public static String join(String separator, Sequence<String> original){
		return join(separator, 0,original.size(), original);
	}
	...
	public static String join(String separator, String first,  String ... original){
		return join(separator, 0,original.length + 1, Sequences.of(first).concat(Sequences.of(original)));
	}
	
	public static String join(String separator, int start, String ... original){
		return join(separator, start, original.length, Sequences.of(original));
	}
	
	public static String join(String separator, int start, int end, Sequence<String>  original){
		StringBuilder builder = new StringBuilder();
		for (int i=start; i < end;i++){
			builder.append(original.get(i)).append(separator);
		}
		if(builder.length()>0){
