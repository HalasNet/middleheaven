...
public class TestFormatter {
	...
	public void quantityMoneyFormatter(){
		...
		assertEquals("R$ 3.000,68" ,formatterPtBR.format(Money.valueOf("3000.68", "BRL")));
		assertEquals("US$ 3.000,68" ,formatterPtBR.format(Money.valueOf("3000.68", "USD")));
		assertEquals("EUR 3.000,68" ,formatterPtBR.format(Money.valueOf("3000.68", "EUR")));
		
		QuantityFormatter formatterPtPT = new QuantityFormatter(Culture.valueOf("pt", "PT"));
		
		assertEquals("3.000,68 BRL" ,formatterPtPT.format(Money.valueOf("3000.68", "BRL")));
		assertEquals("3.000,68 USD" ,formatterPtPT.format(Money.valueOf("3000.68", "USD")));
	
		QuantityFormatter formatterEnUS = new QuantityFormatter(Culture.valueOf("en", "US"));
		
		assertEquals("BRL3,000.68" ,formatterEnUS.format(Money.valueOf("3000.68", "BRL")));
		assertEquals("$3,000.68" ,formatterEnUS.format(Money.valueOf("3000.68", "USD")));
		assertEquals("EUR3,000.68" ,formatterEnUS.format(Money.valueOf("3000.68", "EUR")));
	...
	public void quantityIntegerFormatter(){
		...
		assertEquals("3.000" ,formatterPtBR.format(Int.valueOf("3000")));
		assertEquals("3.012" ,formatterPtBR.format(Int.valueOf("3012")));
		assertEquals("300" ,formatterPtBR.format(Int.valueOf("300")));
	
		QuantityFormatter formatterPtPT = new QuantityFormatter(Culture.valueOf("pt", "PT"));
		
		assertEquals("3.000" ,formatterPtPT.format(Int.valueOf("3000")));
		assertEquals("3.000" ,formatterPtPT.format(Int.valueOf("3000")));
		assertEquals("300" ,formatterPtPT.format(Int.valueOf("300")));
		
		QuantityFormatter formatterEnUS = new QuantityFormatter(Culture.valueOf("en", "US"));
		
		assertEquals("3,000" ,formatterEnUS.format(Int.valueOf("3000")));
		assertEquals("3,000" ,formatterEnUS.format(Int.valueOf("3000")));
		assertEquals("300" ,formatterEnUS.format(Int.valueOf("300")));
