...
public class QuantityFormatter implements Formatter<Quantity<?>>{
	...
	public String format(Number number) {
		return format(Real.valueOf(number));
	}
	...
	public String format(Quantity<?> object) {
		...
		} else if (object instanceof org.middleheaven.quantity.math.Int ){
			return formatInteger((org.middleheaven.quantity.math.Int)object);
	...
	private String formatInteger(org.middleheaven.quantity.math.Int object) {
