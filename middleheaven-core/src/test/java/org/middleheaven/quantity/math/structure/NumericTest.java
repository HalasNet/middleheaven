...
public class NumericTest {
	...
	public void testSimplify(){
		...
		Real real = Real.valueOf("3").over(Fraction.valueOf("15"));
	
		assertEquals(Real.valueOf("5") , real.inverse());
	...
	public void testArcTan(){
		...
		Real ZERO = RealAlgebricStructure.getInstance().zero();
		Real ONE = RealAlgebricStructure.getInstance().one();
	...
	public void testExp(){
		...
		assertInRange(Real.valueOf(Math.E), RealAlgebricStructure.getInstance().one().exp(), 1E-20);
	}
