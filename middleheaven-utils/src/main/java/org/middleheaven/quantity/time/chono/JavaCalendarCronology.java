...
public class JavaCalendarCronology extends AbstractChronology{
	 ...
	 */
	@Override
	public Period periodBetween(TimePoint a, TimePoint b) {
		long max;
		long min;
		...
		return Period.miliseconds(max-min);
	}
	 ...
	 */
	@Override
	public Duration durationBetween(TimePoint a, TimePoint b , DurationUnit unit) {
