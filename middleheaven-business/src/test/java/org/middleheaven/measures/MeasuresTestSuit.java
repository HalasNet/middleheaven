...
public class MeasuresTestSuit {
	...
	public void testMeasureOperations(){
		DecimalMeasure<Distance> threeM = DecimalMeasure.measure(Real.valueOf(3), Real.rational(1, 5), SI.METER);
		DecimalMeasure<Distance> sixM = DecimalMeasure.measure(Real.valueOf(6), Real.rational(1, 4), SI.METER);
		DecimalMeasure<Distance> fiveExactM = DecimalMeasure.exact(Real.valueOf(5), SI.METER);
		
		assertEquals( DecimalMeasure.measure(Real.valueOf(9), Real.rational(9, 20), SI.METER) , threeM.plus(sixM));
		
		
		assertEquals( DecimalMeasure.measure(Real.valueOf(8), Real.rational(1,5), SI.METER) , fiveExactM.plus(threeM));
	...
	public void testMeasures(){
		...
		Int cem =  Int.valueOf(100);
		Int tres =  Int.valueOf(3);
		Int seis =  Int.valueOf(6);
		Int tresentos =  Int.valueOf(300);
	...
	public void testWrongIsoCode(){
		...
		Money.valueOf(330, "EU"); // eu is not a iso code
