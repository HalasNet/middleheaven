...
public final class Reflector {
	...
	public  <T> T proxyType (Class<T> facadeClass , final ProxyHandler delegator, Sequence<Object> args){
		return proxyCreationStategy.proxyType(facadeClass, delegator, args);
	}

	public  <T> T proxyType (Class<?> facadeClass , final ProxyHandler delegator,Class<T> proxyInterface , Sequence<Class<?>> adicionalInterfaces){
		
		if (!adicionalInterfaces.isEmpty()){
	...
	public  <I> I proxyObject (Object delegationTarget , final ProxyHandler delegator , Class<I> proxyInterface , Sequence<Class<?>> adicionalInterfaces){
