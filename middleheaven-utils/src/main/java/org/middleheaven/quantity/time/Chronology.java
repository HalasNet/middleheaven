...
public abstract class Chronology {
	 ...
	 * @return
	 */
	public abstract Duration durationBetween(TimePoint calendarDateTime,TimePoint other, DurationUnit unit);

	public abstract Period periodBetween(TimePoint calendarDateTime,TimePoint other);
